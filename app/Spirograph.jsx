...
const PRESET_PATTERNS = [
  { name: 'Classic Star', R: 80, r: 30, d: 50 },
  { name: 'Flower', R: 100, r: 60, d: 80 },
  { name: 'Tight Loops', R: 70, r: 20, d: 60 },
  { name: 'Wild Card', R: 90, r: 45, d: 85 },
  { name: 'Delicate', R: 100, r: 25, d: 20 },
  { name: 'Galaxy', R: 85, r: 55, d: 90 },
];
...
export default function Spirograph() {
  ...
  const [penDistance, setPenDistance] = useState(50);
  ...
  const [drawingMode, setDrawingMode] = useState(DRAWING_MODES.AUTO);
  ...
  const draw = useCallback(() => {
    ...
    if (showGears && isDrawing && pointsRef.current.length > 0) {
  ...
  }, [backgroundColor, penColor, lineWidth, showGears, isDrawing, progress, outerRadius, innerRadius, penDistance, getTotalRotations, drawGears, drawingMode, currentAngle]);
  ...
  const handleMouseDown = useCallback((e) => {
    ...
    // On first click, add the starting point
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-2 bg-gradient-to-r from-pink-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent">
          Virtual Spirograph
        </h1>
        <p className="text-center text-slate-400 mb-8">Create mesmerizing geometric patterns</p>
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start justify-center">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 shadow-2xl border border-slate-700/50 w-full lg:w-80">
